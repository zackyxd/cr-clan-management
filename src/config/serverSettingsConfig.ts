...
//   member_channels: 'member_channel_settings',
// };
...
//   purpose: string
// ) {
//   // Import and use the centralized builder
//   const { buildFeatureEmbedAndComponents } = await import('./serverSettingsBuilder.js');

//   try {
//     // Map the feature key to our registry feature name
//     // In the future, we should fully migrate to using registry names directly
//     const featureName = featureKey;

//     return await buildFeatureEmbedAndComponents(guildId, ownerId, featureName);
//   } catch (error) {
//     console.error('Error building feature UI:', error);

//     // Fallback to original implementation if there's an error with the new system
